 ...
 * У масиві A з 14 елементів замінити всі від'ємні елементи на парних місцях
 * середнім арифметичним усіх від'ємних елементів, а від'ємні елементи на
 * непарних місцях — середнім арифметичним усіх додатних елементів.
 * Особливі випадки: усі елементи від'ємні -> заміна на 0;
 *                   усі елементи додатні  -> заміна на 1.
 * Версія 1: масив ініціалізовано в коді програми.
 */
#include <stdio.h>
...
void transform(const double a[], double c[], int n)
{
    ...
    if (cnt_neg == 0) {
        /* усі елементи додатні: елементи на парних місцях замінюємо на 1 */
    ...
    if (cnt_pos == 0) {
        /* усі елементи від'ємні: замінюємо на 0 */
