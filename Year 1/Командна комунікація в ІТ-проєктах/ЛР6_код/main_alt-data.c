 ...
 * Гілка alt-data: масив, що не задовольняє умову (усі елементи додатні),
 * для перевірки особливого випадку з п. 8 завдання.
 */
#include <stdio.h>
...
int main(void)
{
    /* альтернативний набір даних: від'ємних елементів немає */
